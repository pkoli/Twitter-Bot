...
def auto_follow(q, count=2000, result_type="recent"):
...
def auto_follow_followers_for_user(user_screen_name, count=2000):
    """
...
def dm_followers():
	...
	for user_id in followers:
		...
		t.direct_messages.new(user_id=user_id,text="Invitation for online paid surveys, register on www.cinchbucks.com/register to earn upto $5 per survey.#CinchBucks")
	return
	
	
	
if __name__ == "__main__":
	#auto_fav("#Something",200,"recent")
	auto_mute_following()
	#get_do_not_follow_list()
